                ...
                child: Obx(
                  () => Column(
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          Navigation.navigateTo(page: 'ForgotPassword');
                        },
                        child: Align(
                        ...
                        children: [
                          Expanded(
                            child: SingleTapDetector(
                                onTap: () {
                                  Navigation.navigateTo(page: 'LoginQr');
                                },
                                child: Container(
                                  padding: EdgeInsets.symmetric(
                                      horizontal: 24, vertical: 12),
                          ...
                          Expanded(
                            child: SingleTapDetector(
                                onTap: () {
                                  Navigation.navigateTo(page: 'Register');
                                },
                                child: Container(
                                  padding: EdgeInsets.symmetric(
                                      horizontal: 24, vertical: 12),
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () async {
                              ...
                              if (controller.isOTP.value) {
                                if (controller
                                    .textOTPRegister.text.isNotEmpty) {
                        ...
                        Center(
                          child: Text(
                            ...
                            style: TextStyle(
                                fontSize: 24.sp,
                                fontWeight: FontWeight.w500,
                                color: const Color.fromARGB(255, 75, 87, 122)),
                          ),
                        ),
                        controller.forgotPassState.value == 0
                            ? Text(
                              ...
                              Container(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    // labelText: TextByNation.getStringByKey('username'),
                                    labelText:
                                        TextByNation.getStringByKey('otp'),
                                    floatingLabelStyle: TextStyle(
                                        color: Color.fromRGBO(17, 185, 145, 1)),
                                    labelStyle: TextStyle(
                                        color: Get.isDarkMode
