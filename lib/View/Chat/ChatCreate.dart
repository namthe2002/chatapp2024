...
class ChatCreate extends StatelessWidget {
  ...
  AppBar appBar() {
    return AppBar(
      iconTheme: IconThemeData(color: Get.isDarkMode ? Colors.white : ColorValue.neutralColor),
      // centerTitle: true,
      elevation: 0,
      titleSpacing: 15,
      leading: IconButton(
        ...
        child: Padding(
          ...
          child: Row(
            children: [
              Stack(
                children: [
                  controller.listContact[index].avatar != null && controller.listContact[index].avatar!.isNotEmpty
                      ? ClipOval(
                          child: Container(
                            width: 48,
                            height: 48,
                            decoration: BoxDecoration(),
                            child: Image.network(
                              Constant.BASE_URL_IMAGE + controller.listContact[index].avatar.toString(),
                              fit: BoxFit.cover,
                      ...
                      : Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              gradient: Utils.getGradientForLetter(controller.listContact[index].fullName == null
                                  ? controller.listContact[index].userName.toString()
                                  : controller.listContact[index].fullName.toString())),
                          child: Center(
                              child: Text(
                            Utils.getInitialsName(controller.listContact[index].fullName == null
                                    ? controller.listContact[index].userName.toString()
                                    : controller.listContact[index].fullName.toString())
                                .toUpperCase(),
              ...
              Expanded(
                ...
                children: [
                  ...
                  Text(
                    TextByNation.getStringByKey('last_seen') + ' ' + Utils.getTimeMessage(controller.listContact[index].lastSeen!),
                    maxLines: 2,
                    overflow: TextOverflow.ellipsis,
                    style: TextStyle(
                        fontSize: 14, fontWeight: FontWeight.w400, color: Get.isDarkMode ? ColorValue.colorTextDark : ColorValue.colorBorder),
                  ),
                ],
              )),
            ],
