            ...
            children: List.generate(controller.listImage.length, (index) {
              ...
              return StaggeredGridTile.count(
                ...
                child: GestureDetector(
                  onTap: () {
                    // Navigation.navigateTo(page: RouterName.media_chat_detail, arguments: Constant.BASE_URL_IMAGE + controller.listImage[index]);
                  },
                  child: ClipRRect(
                      borderRadius: BorderRadius.circular(12),
                      child: Utils.getFileType(Constant.BASE_URL_IMAGE + controller.listImage[index]) == 'Video'
                          ? SizedBox(
                              child: Text('LoadingVideo'),
                            )
                          ...
                          popupMenuButton: controller.roleId != 1 &&
                              ...
                              : Visibility(
                                  ...
                                  child: PopupMenuButton(
                                    ...
                                    icon: SvgPicture.asset(Images.three_dot_horizontal_ic),
